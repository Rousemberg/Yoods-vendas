  ...
  <div class="box">
    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div class="field">
        ...
        <div class="control">
          <input class="input" id="cnpj" v-model="form.cnpj" type="text" required placeholder="CNPJ" />
        </div>
      </div>
      <div class="field">
        <label class="label" for="companyName">Razão Social</label>
        <div class="control">
          <input class="input" id="companyName" v-model="form.companyName" type="text" required placeholder="Company Name" />
        </div>
      </div>
